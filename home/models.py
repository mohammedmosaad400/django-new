...
class News(models.Model) :
    # fields
    news_Title=models.CharField(default='خبر عاجل',max_length=200,help_text='أدخل عنوان الخبر', verbose_name='عنوان الخبر')
    news_Img=models.ImageField(null=True,blank=True,default='',upload_to='home/static/img', help_text='قم بتحميل صورة الخبرة', verbose_name='صورة الخبر' )
    news_Date=models.DateTimeField(null=True,blank=True,default=timezone.now, help_text='أدخل الوقت والتاريخ',verbose_name='الوقت والتاريخ')
...
class Slide(models.Model):
    slide_img=models.ImageField(null=True,blank=True,upload_to='home/static/img/slideShow',help_text='قم برفع الصورة',verbose_name='الصورة')
...
class Agriculture_Suggestion(models.Model):
    title = models.CharField(default='مقترح زراعي',max_length=500,help_text='عنوان الإقتراح',verbose_name='عنوان الإقتراح')
...
class Industrial_Suggestion(models.Model):
    title = models.CharField(default='مقترح صناعي',max_length=500,help_text='عنوان الإقتراح',verbose_name='عنوان الإقتراح')
    content = models.TextField(default='محتوى الإقتراح ...',verbose_name='محتوى الإقتراح')
    class Meta:
        ordering = ['title' ,'content', ]
...
class Development_Suggestion(models.Model):
    title = models.CharField(default='مقترح تنموي',max_length=500,help_text='عنوان الإقتراح',verbose_name='عنوان الإقتراح')
    content = models.TextField(default='محتوى الإقتراح ...',verbose_name='محتوى الإقتراح')
    class Meta:
        ordering = ['title' ,'content', ]
...
class Service_Suggestion(models.Model):
    title = models.CharField(default='مقترح خدمي',max_length=500,help_text='عنوان الإقتراح',verbose_name='عنوان الإقتراح')
    content = models.TextField(default='محتوى الإقتراح ...',verbose_name='محتوى الإقتراح')
    class Meta:
        ordering = ['title' ,'content', ]
...
class Tourist_Suggestion(models.Model):
    title = models.CharField(default='مقترح سياحي',max_length=500,help_text='عنوان الإقتراح',verbose_name='عنوان الإقتراح')
    content = models.TextField(default='محتوى الإقتراح ...',verbose_name='محتوى الإقتراح')
    class Meta:
        ordering = ['title' ,'content', ]
...
class Organization_Leader(models.Model):
    organization_leader = models.CharField(default='قيادات الهيئة',max_length=300,help_text='قيادات الهيئة',verbose_name='قيادات الهيئة')
    class Meta:
...
class Organization_Governing_Council(models.Model):
    title = models.CharField(default='مجلس الإدارة',max_length=300,help_text='اللقب',verbose_name='اللقب أو الدرجة')
    name = models.CharField(default='عضو مجلس الادارة',max_length=400,help_text='الاسم',verbose_name='الاسم')
    class Meta:
        ordering = ['title','name']
...
class Organization_Law(models.Model):
    law_title = models.CharField(default='اسم القانون',max_length=1000,help_text='الوثيقة',verbose_name='عنوان الوثيقة')
    law_date = models.DateField(default=timezone.now,help_text='التاريخ',verbose_name='تاريخ الوثيقة')
    law_content = models.FileField(default='محتوى القانون',help_text='ملف الوثيقة',verbose_name='ملف الوثيقة',upload_to='home/static/docs')
    class Meta:
...
class Project_Ended(models.Model):
    project_name = models.CharField(default='اسم المشروع',max_length=500,help_text='اسم المشروع',verbose_name='اسم المشروع')
...
class Complaint(models.Model):
    ...
    Complaint_date=models.DateTimeField(default=timezone.now,null=True,blank=True,help_text="التاريخ",verbose_name='الوقت والتاريخ')
...
class Suggestion(models.Model):
    ...
    suggestion_date=models.DateTimeField(default=timezone.now,null=True,blank=True,help_text="التاريخ",verbose_name='الوقت والتاريخ')
    ...
    suggestion_kind = models.CharField(default=choices[1],max_length=100,choices=choices,help_text='نوع الإقتراح',verbose_name='نوع الإقتراح')
